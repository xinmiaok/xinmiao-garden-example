...
Nodes:
 - "TABLE file.name, \"([\", \"])\", \"yellow\" FROM  #book where !contains(file.folder, \"40 - Obsidian\")"
Links:
 - "TABLE WITHOUT ID status, file.name, \"\" FROM #book WHERE status FLATTEN status where !contains(file.folder, \"40 - Obsidian\")"
Styles:
